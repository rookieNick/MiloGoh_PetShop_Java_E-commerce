...
<%
 ...
 MaintainReviewControl reviewRecords = new MaintainReviewControl();
 Review review = reviewRecords.selectReviewById(Integer.parseInt(request.getParameter("id")));
%>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>${companyName} | Be Honest ! </title>
        <!-- Style CSS -->
    ...
    <body>
        ...
        <main class="cd__main">
            ...
            <div class="wrapper"> 
                ...
                <form action="../ModifyReviewServlet" method="post">
                    <!-- Input field for the review ID -->
                    <input type="hidden" name="reviewId" value="<%=review.getReviewid()%>">
                    <!-- Input field for the account ID -->
                    <input type="hidden" name="accountId" value="<%=review.getAccountid()%>">
                    ...
                    <textarea name="content" name="review" cols="30" rows="6" placeholder=""><%=review.getContent()%></textarea>

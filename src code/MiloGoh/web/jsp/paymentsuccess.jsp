<%-- 
    ...
    Created on : 5 May 2024, 2:08:42 am
    Author     : limch
--%>
...
<html>
    <head>
        ...
        <title>${companyName} | Thanks !</title>
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" cols="3" bgcolor="white" class="bordered-left-right" style="border-left: 10px solid #d7d7d7; border-right: 10px solid #d7d7d7; max-width: 600px; width: 100%;">
                        ...
                        <tr align="left">
                            ...
                            <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                ...
                                <br>
                                <%
                                    Product formatterrrr = new Product();
                                    String totalAmount = request.getParameter("totalAmount");
                                    String orderId = request.getParameter("orderId");
                                    %>
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0; "><strong>Payment Details:</strong>
                                    <br/>Amount: RM<%=formatterrrr.rmFormat(Double.parseDouble(totalAmount))%> <br/>Account ID : <%=accountID%><br/>Email : <%=gmail%><br/></p>
                                <br>
                        ...
                        <tr align="center">
                            <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                            <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                                <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"><strong><a href="home.jsp">Back to Home Page<a></strong></p>
                            </td>
                            <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                        </tr>
